# Cisco Apuntes — Curso Udemy CCNA

> [Acceso al Curso](https://www.udemy.com/redes-con-equipos-cisco-ccna-200-120/learn/v4/overview)

## Índice

1. [Comandos Básicos](#comandos-básicos)
2. [Recuperar Password Enable IOS](#recuperar-password-enable-ios)
3. [Conseguir Contraseñas CISCO](#conseguir-contraseñas-cisco)
4. [Configuración Básica](#configuración-básica)
5. [SSH](#ssh)
6. [VLANs](#ahora-vamos-a-configurar-las-vlans)
7. [Trunk entre 2 Switches](#configuración-de-un-trunk-entre-2-switches-para-2-vlans-distintas)
8. [Securizar Puertos Switch](#securizar-puertos-switch)
9. [CDP](#cdp)
10. [VTP](#vtp)
11. [InterVLAN Routing (Router on Stick)](#intervlan-routing--router-on-stick-)
12. [SPAN](#span--switch-port-analizer-)
13. [STACKWISE](#stackwise)
14. [Enrutamiento](#enrutamiento)
15. [HLDC](#hldc)
16. [PPP / PAP / CHAP](#ppp)
17. [Frame Relay](#frame-relay)
